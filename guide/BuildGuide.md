...
> [!WARNING]
> - Amazonのリンクに関して、在庫切れが生じると自動的に別バリエーションへ誘導される事象を確認しております。参考リンクに掲載された製品をそのまま買う前に、ビルドガイドの仕様と一致しているかを確認していただけますようお願い申し上げます。
